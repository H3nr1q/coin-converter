...
import br.com.dio.coinconverter.domain.di.GetExchangeValueUseCases
...
class MainViewModel(
    ...
    private val getExchangeValueUseCases: GetExchangeValueUseCases
    ...
    fun getExchangeValue(coins: String){
        viewModelScope.launch {
            getExchangeValueUseCases(coins)
